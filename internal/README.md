...
| `obras_externas_depuradas.csv` | Filas que las reglas sacaron de la cola, con la regla que lo hizo y —para título repetido— la fila que las sustituye | `make revisar-obras-externas` |
