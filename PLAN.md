...
| T-10 | Red de coautoría autor–autor derivada de `Autoria` | V2 | **El grafo ya se construye**: `src/build/grafo_coautoria.py` (538 personas, 616 pares tras la consolidación del 2026-08-26, componentes y comunidades de Louvain, sin dependencias externas) y `make red` dibuja la vista real en `internal/red_coautoria.html`, con las mismas primitivas que usará el sitio. **`T-03` ya se cerró** (2026-08-26): la vista puede volver a revisarse para decidir si publica, en vez de seguir bloqueada |
