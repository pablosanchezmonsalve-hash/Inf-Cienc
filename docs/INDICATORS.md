...
| `P-06` | Autores UFT distintos | Formas de firma detectadas | `count(distinct autor)` | tabla maestra | **parcial** 589 | media | ✅ | **589 formas de firma, no 589 personas** (123 variantes + 20 perfiles fragmentados) |
...
| `AU-05` | ORCID | Identificador persistente | — | — | **no** 0/589 | no disp. | placeholder | Se muestra con leyenda «no disponible», no se oculta |
